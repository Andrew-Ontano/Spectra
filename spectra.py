...
def main():
    ...
    parserCount.add_argument('-w', '--width', dest='width', type=int, help='Window width', default='10000')
    parserCount.add_argument('-s', '--spacing', dest='spacing', type=int, help='Window spacing', default='10000')
    ...
    parserCount.add_argument('-m', '--mer-size', dest='mer_size', type=int, help='kmer size to tabulate.', default=3)
    ...
    parserCount.add_argument('-t', '--threads', dest='threads', type=int, help='Number of threads for parallel processing', default=1)
    ...
    parserQuery.add_argument('-d', '--consolidate', dest='consolidate', action='store_true', help='Consolidate all records into single column', default=False)
    ...
    parserQuery.add_argument('-n', '--no-overlap', dest='overlap', action='store_false', help='Count base pairs in repetitive runs of nucleotides only once.', default=True)
    parserQuery.add_argument('-k', '--chunk-size', dest='chunk_size', type=int, help='Max chunk size to work on', default=30000000)
    parserQuery.add_argument('-t', '--threads', dest='threads', type=int, help='Number of threads for parallel processing', default=1)
